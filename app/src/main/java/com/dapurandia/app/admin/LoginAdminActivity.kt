    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginButton.setOnClickListener {
            ...
            if (email.isEmpty() || password.isEmpty()) {
                showAutoDismissDialog("Login Gagal", "Email dan password tidak boleh kosong")
                        ...
                        db.collection("admins").document(userId)
                            ...
                            .addOnSuccessListener { document ->
                                ...
                                if (document.exists()) {
                                    ...
                                    auth.signOut()
                                    showAutoDismissDialog("Login gagal", "mohon cek ulang email dan password Anda.")
                                }
                            }
                            .addOnFailureListener { e ->
                                progressBar.visibility = View.GONE
                                showAutoDismissDialog("Error", "Gagal memeriksa role: ${e.message}")
                            }
                    } else {
                        progressBar.visibility = View.GONE
                        showAutoDismissDialog("Login Gagal", getLoginErrorMessage(task.exception))
                    }
                }
        }
    }
